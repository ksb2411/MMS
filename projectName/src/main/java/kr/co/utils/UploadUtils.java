...
public class UploadUtils {
	...
	public static String uploadFile2(MultipartFile file, String filename, String uploadpath) throws Exception {
		...
		//filename : /2021/12/24/s_uuid_a.png
		//savedName : /2021/12/24/uuid_a.png
		//filename : /2021/12/24/uuid_a.txt
	...
	private static String makeThumbnail(String uploadpath, String datePath, String savedName) throws Exception {
		...
		// =>srcFile을 램에 저장하고 그 이미지를 sourceImg라 명칭함.
		...
		// =>램에 저장된 썸네일코드 destImg를 대문자 formatName의 파일명으로 newFile에 생성한다
	...
	private static String makeIconInfo(String datePath, String savedName) {
		...
		// => OS가 windows인 상황에서 File.separatorChar를 '/'로 변경
	...
	public static String getFormatName(String filename) {
		...
		// =>filename이라는 문자열에서 인덱스가 idx+1인곳에서부터 잘라내어 formatName에 넣는다.
	...
	public static MediaType getMediaType(String formatName) {
		...
		// =>key의 자료형은 String, value 값은 MediaType인 map객체를 생성한다.
		...
		/*
		 * =>mediaMap이라는 맵 객체에 저장된 값들 중 key가 formatName인 값을 가져와서 mediaType에 대입하라.
		 */
		return mediaType;
